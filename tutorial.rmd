...
Linear and logistic regressions are both machine learning algorithims, one based on supervised regression and the other is based on supervised classification, repspectively.
